...
function App() {
  ...
  // taking the all currency options
  const options = Object.keys(currencyInfo); // our currencyoptions array yahi to hai after hitting the api
      ...
      <div className="w-full">
        <div className="w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-black/30">
          <form
            onSubmit={(e) => {
              e.preventDefault();
              convert(); // after submitting the form convert method is geting executed
            }}
          >
